    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              ...
              <div>
                Safe <span className="ft-sign">+</span>
              </div>
            </p>
            <p className="ft-description">
              Talk to online doctors and get medical advice, online
              prescriptions, refills and medical notes within minutes. On-demand
              safecare services at your fingertips.
            </p>
          </div>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@safeplus.com">support@safeplus.com</a>
            </li>
            <li>
              <a href="mailto:appointment@safeplus.com">
                appointment@safeplus.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2013-2023 Safe+. All rights reserved.</p>
